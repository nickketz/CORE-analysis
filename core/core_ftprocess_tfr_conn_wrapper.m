function core_ftprocess_tfr_conn_wrapper(whichStages)
% tnt_ftprocess_tfr_pow_wrapper(whichStages)
%
% To run on dream, at the command line type: distmsub core_ftprocess_tfr_conn_wrapper.m
%
...
if runLocally == 0
  ...
  [exper] = nk_ft_concatTrialCounts_cluster(job,exper,allSubjects);
